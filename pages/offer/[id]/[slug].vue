      ...
      <div class="bg-white rounded-lg shadow-lg p-6 sm:p-8 mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div class="flex-1">
            ...
            <NuxtLink :to="`https://suitops.netlify.app/company/${currentJob.company.id}/${currentJob.company.name}`"
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-gray-700">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 space-y-8">
          <div v-if="!hasDetails"
            ...
            <p class="font-medium">Aucun détail spécifique défini pour ce poste. Veuillez consulter le résumé ou
              contacter l'entreprise.</p>
          </div>
        ...
        <div class="space-y-8">
          <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4 text-gray-700">
              ...
              <NuxtLink :to="`/offer/company/${currentJob.company.id}/${currentJob.company.name}`"
                :title="`Voir plus d'offre de ${currentJob.company.name}`"
          ...
          <div v-else class="bg-yellow-50 border border-yellow-200 text-yellow-800 p-6 rounded-lg shadow-sm">
            <p class="font-medium text-center">Les documents requis ne sont pas spécifiés. Veuillez soumettre les
          ...
          <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div v-if="currentJob.quizzes && currentJob.quizzes.length > 0"
              class="text-green-700 bg-green-50 p-4 rounded-md flex items-center gap-2">
